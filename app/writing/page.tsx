      ...
      <section className="pt-12 pb-16 md:pt-20 md:pb-20">
        <Container>
          <div className="flex items-center gap-3 font-mono text-[11px] uppercase tracking-caps">
            ...
            <span className="text-muted">/ Vol. 04</span>
          </div>
        ...
        <Container size="narrow">
          <div className="border-t-2 border-ink pt-14">
            ...
            <p className="mt-6 font-display-tight text-[clamp(1.75rem,3vw,2.5rem)] leading-[1.1] text-ink">
              These essays live alongside the work. Most start as a working note on a client project. When the argument generalises, it becomes an essay. When it&rsquo;s narrower, a briefing. Nothing is published until it holds up on its own.
            </p>
          </div>
        </Container>
      </section>
