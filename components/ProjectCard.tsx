...
const tiles = [
  ...
  { bg: "bg-soft", fg: "text-ink", accent: "text-electric" },
  { bg: "bg-deep", fg: "text-paper", accent: "text-lemon" },
] as const;
...
function ProjectTile({
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-x-6 bottom-[3.5rem] hidden h-px opacity-30 md:block" style={{ backgroundColor: "currentColor" }} />
    </div>
  );
}
